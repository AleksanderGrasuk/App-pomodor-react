...
export function ConfigTimer({
	...
	smallBreakTimeValue,
	largeBreakTimeValue,
	setPomodoroInMinValue,
	setSmallBreakTimeValue,
	setLargeBreakTimeValue,
}: IConfigTimerProps) {
	...
	function handleSmallBreakTimeValueChange(
	...
	function handleLargeBreakTimeValueChange(
		event: React.ChangeEvent<HTMLInputElement>
	) {
		let newValue = handleChange(event);
	...
	const cancellation = classNames(styles.btn, styles.cancellation);

	const reset = classNames(styles.btn, styles.reset);

	const save = classNames(styles.btn, styles.save);
		...
		<div className={styles.config} ref={configRef}>
			...
			<form className={styles.form} onSubmit={handleSubmit}>
				...
				<div className={styles.divBtn}>
					<button className={cancellation} onClick={closeSettings}>
						Отмена
					</button>
